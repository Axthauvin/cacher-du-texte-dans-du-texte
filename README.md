...
***I explain below how the project works, but an englisg version is available. [See directly the English explanation :uk:](#-how-did-i-hid-text-in-text)<a style="color:white;" href="https://github.com/Axthauvin/cacher-du-texte-dans-du-texte/blob/main/README.md#-how-did-i-hid-text-in-text"></a>***
